...
(def-doom-theme doom-outrun-electric
  ...
  ((bg         '("#0c0a20" "#0c0a20" nil           ))
   (bg-alt     (doom-lighten '("#090819" "#090819" nil) 0.10))
   ...
   (fg         (doom-darken '("#f2f3f7" "#f2f3f7" "brightwhite" ) 0.2))
   ...
   (magenta    (doom-darken '("#ff2afc" "#ff2afc" "magenta") 0.2))
   (violet     '("#df85ff" "#df85ff" "brightmagenta"))
   (cyan       (doom-darken '("#42c6ff" "#42c6ff" "brightcyan") 0.2))
